...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Hospede hospede2 = new Hospede("1234", "Maria", "maria@email.com", "Alameda dos Anjos, 30");
        ...
        Hospede hospede4 = new Hospede("12345", "Joao", "joao2@email.com", "Rua das Graças, 51");

        // manager.editar(hospede4);
